...
<?php 
$triangle_shape = "";
$icon = get_sub_field('content_type_list_icon');
...
?>
<section
    class="section b-list<?php echo $triangle_shape ?> grid-wrapper<?php echo (is_null($content) || $content== 'automatic') ? '' : ' sections--colors-content-' . $content ?><?php echo (is_null($accent) || $accent== 'automatic') ? '' : ' sections--colors-highlight-' . $accent ?><?php echo ($main == 'automatic') ? '' : ' sections--colors-section-' . $main; ?>">
    <div class="grid-center">
        <div class="title title--one-line" data-scrolly="fromLeft">
            <div class="title__content">
                <h3><?php echo get_sub_field("content_type_list_title"); ?></h3>
        ...
        <?php if( have_rows('content_type_list_lists') ): ?>
        <ul class="grid grid-2">
            <?php while( have_rows('content_type_list_lists') ): 
                        the_row(); 
                    ?>
