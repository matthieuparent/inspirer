...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210813_inspirerrespirer_3769c43e225099459846_20210813141143_archive.zip';
	const ARCHIVE_SIZE		 = '44819659';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3769c43-13141143';
    const SECONDARY_PACKAGE_HASH = 'f8c2242-13141143';
	const VERSION			 = '1.4.2';
