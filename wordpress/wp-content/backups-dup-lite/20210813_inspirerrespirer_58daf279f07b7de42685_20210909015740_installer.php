...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210813_inspirerrespirer_58daf279f07b7de42685_20210909015740_archive.zip';
	const ARCHIVE_SIZE		 = '65858513';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '58daf27-09015740';
    const SECONDARY_PACKAGE_HASH = 'f862504-09015740';
	const VERSION			 = '1.4.2';
