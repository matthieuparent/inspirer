...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210813_inspirerrespirer_f9557904f28ca6c39203_20210825013244_archive.zip';
	const ARCHIVE_SIZE		 = '59874815';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f955790-25013244';
    const SECONDARY_PACKAGE_HASH = '7917922-25013244';
	const VERSION			 = '1.4.2';
